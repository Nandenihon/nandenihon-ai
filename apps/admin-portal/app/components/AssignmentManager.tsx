...
export default function AssignmentManager({ classId }: { classId?: number }) {
    ...
    async function create(event: React.FormEvent) {
        ...
        const response = await fetch("/api/enrollment/assignments", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...form, classId: Number(classId || form.classId) }) });
